...
#define red_led_off   writePinHigh(B0)
#define red_led_on    writePinLow(B0)
#define blu_led_off   writePinHigh(B7)
#define blu_led_on    writePinLow(B7)
#define grn_led_off   writePinHigh(B12)
#define grn_led_on    writePinLow(B12)
#define wht_led_off   writePinHigh(B7)
#define wht_led_on    writePinLow(B7)
